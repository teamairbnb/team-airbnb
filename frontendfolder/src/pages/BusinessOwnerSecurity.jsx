...
function Security() {
  ...
  const handleConfirm = () => {
    alert(
      `Security method saved: ${
        selectedOption === "authenticator"
    ...
    <div className="flex flex-col min-h-screen w-full bg-gray-50">
      <div className="relative flex items-center justify-center my-6 mx-4">
        ...
        <p className="font-semibold text-[#11182773]">
          Profile / <span className="text-[#111827]">Security</span>
        </p>
      </div>
      ...
      <div className="w-full max-w-md mt-10 px-6 flex-grow">
        <div className="flex flex-col gap-6">
          <div className="bg-white rounded-lg shadow-sm px-4 py-4">
            ...
            <p className="text-sm text-gray-500">Use Google Authenticator</p>
          </div>
