...
export default function OwnerCar() {
  return (
    <div className="flex flex-col text-[#111827]">
      <div className="bg-[#2563EB] px-4 py-1 w-32 flex items-center gap-3 text-white rounded-t-xl rounded-br-xl translate-y-4">
        <div className="bg-[#16A34A] h-3 w-3 rounded-full"></div>
        <p className="text-[17px]">Available</p>
      </div>
      <img className="" src={mercedes} alt="" />
      <img
        className="w-5 -translate-y-44 translate-x-[360px]"
        src={editicon}
        alt=""
      />
      <div className="w-full border shadow-lg rounded-b-xl -translate-y-4 px-4 pt-[18px] pb-5">
